...
public class DisplayMerchantGraph extends JFrame {

    //build the chart
    public DisplayMerchantGraph(String appTitle, ArrayList<Integer> foodPerWeek) {
        super(appTitle);
        // Create Dataset
    ...
    private CategoryDataset prepDataset(ArrayList<Integer> wallet) {
        ...
        for(int i = 0; i < wallet.size(); i++){
            ...
            dataset.addValue(wallet.get(i),season,week);
        }
        return dataset;
    }
}
